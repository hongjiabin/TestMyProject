...
import com.xtone.mms.utill.ConfigManager;
...
public abstract class ConnConfigMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        System.out.println(ConfigManager.getConfigData("MainConfigDbServer"));
        System.out.println(ConfigManager.getConfigData("MainConfigUserName"));
        System.out.println(ConfigManager.getConfigData("MainConfigPassword"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
